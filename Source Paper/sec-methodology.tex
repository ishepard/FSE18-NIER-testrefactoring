...
% As a subquestion of \textbf{RQ2} it would be interesting to know which test code refactoring methods have a positive or negative effect on the maintainability of production code. This way developers can be encouraged or discouraged to use different methods, like methods described in \cite{van2001refactoring}.\\
